...
let scans = await poolMGFT.query(`select id, partner_id, created, contract_id, origin, product_id from AccessLogs where id between 8589926 AND 8602385 ORDER BY DATA_TYPE DESC`)
